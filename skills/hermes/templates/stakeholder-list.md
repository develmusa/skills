...
The stakeholder list is developed for the first time in the initiation phase and forms the basis for managing the stakeholders, for direct cooperation with them, and for communication planning. It is continuously updated over the course of the project.
...
| No. | stakeholder group | Organization | Position | person | Contact details |
| --- | --- | --- | --- | --- | --- |
| 01 | ... |   |   |   |   |
| 01 |   | Office abc |   | H. Peter |   |
| 02 |   | Office xyz |   | M. Meier |   |
| ... |   |   |   |   |   |
