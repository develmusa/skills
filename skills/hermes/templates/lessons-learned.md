...
The lessons learned are systematically collected and continuously documented as a project review. They support the continual improvement process in the project and in the core organization. They provide valuable information for the further course of the project and possible indicators for subsequent projects by identifying and adopting positive aspects and preventing negative aspects as far as possible.
...
| Contact | Subject area | Date | Lessons learned: positive/negative | Relevance: possible significance for own project or other projects | Possible causes | Recommendation; notes for the core organization |
| --- | --- | --- | --- | --- | --- | --- |
| ... |   |   |   |   |   |   |
| Gilles Monard | Procurement | dd.mm.yyyy | Advice from the procurement department on procurement planning was very helpful. | Other projects; PM Competence Center | --- | Include in checklist xyz |
| ... |   |   |   |   |   |   |
