...
## Test cases from the test concept
> _Copy test cases from the test concept into the following table._

| ID | Meaning | Test date | Tester | DC* | Description of defect / comments |
| --- | --- | --- | --- | --- | --- |
| T-01 |   | dd.mm.yyyy |   |   |   |
| T-01 | Entering new master data |   | Hans Meier | 0 |   |
| T-02 | Delete master data |   | Bea Keller | 1 |   |
| ... |   |   |   |   |   |

* DC = defect class according to test concept
