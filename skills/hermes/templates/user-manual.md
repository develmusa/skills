...
The user manual contains all the information that the user of a product/system needs to use it properly and to be able to react correctly in the event of problems.
...
## Functions
> _Description of the product's functions, derived from the product concept_

| No. | Functions | Description |
| --- | --- | --- |
| 01 |   |   |
| 01 | Data transmission | Sending and receiving data via RFID |
| 02 | Data display | Data stored on the device can be displayed grouped according to various criteria |
| ... |   |   |

## Detailed descriptions of use

...
> _Description of how the solution is to be applied by the user, if necessary with the help of a graphical representation_
