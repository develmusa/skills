...
The review report records review findings and documents the execution decisions concerning the findings, as well as the decision on the status of the outcome.
...
| Ref. no. | Outcome to be checked | Review method | Review date | Reviewer | Findings | Outcome decision* | Execution decision |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 01 |   |   |   |   |   |   |   |
| 01 | Concept XY | Written Review | dd.mm.yyyy | Yves Bertrand | Initial situation too vague | 02 | Revision by author |
| 02 | Revised concept XY | Written Review | dd.mm.yyyy | Yves Bertrand |   | --- | Approved |
| ... |   |   |   |   |   |   |   |

* Outcome decision: 1 = formal error, 2 = content error - not critical, 3 = disqualifying error
